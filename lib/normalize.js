...
module.exports = function( params, dir ) {
    ...
    if ( params.input === undefined ) {
        ...
        pathToInput = validatePath( params.input, params.basedir );
        ...
        for ( var i = 0; i < params.input.length; i++ ) {
            ...
            pathToInput = validatePath( params.input[i], params.basedir );
...
var validatePath = exports.validatePath = function( filePath, dir ) {
    ...
    var typeIsCSS = ( ( path.extname( filePath ) === '.css' ) || ( path.extname( filePath ) === '.styl' ) || ( path.extname( filePath ) === '.less' ) );
