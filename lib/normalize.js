...
module.exports = function( params, callback ) {
    ...
    if ( params.errors.includes === undefined ) {

        params.errors.includes = 'alert';

    }

    else if ( errorReportingModes.indexOf( params.errors.includes ) === -1 ) {

        err += '\n' + params.errors.includes + ' is not an acceptable includes value.';
