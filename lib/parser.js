...
Parser.prototype.parse = function ( callback ) {
    ...
    async.map( filesList, that.importsReplace, function( err, results ) {
        ...
        for ( var file = 0; file < results.length; file++ ) {
    ...
    if ( fs.existsSync( pathToFile ) ) {
        ...
        async.waterfall( [
            ...
            function( data, callback ) {
                ...
                new Processor( data, fileExtension, pathToFile, that.config.nib ).parse( function( err, data ) {
            ...
            function( data, callback ) {
                ...
                that.importsSearch( data, fileDir, pathToFile, that, function( data ) {
