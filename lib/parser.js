...
exports.init = function ( input, output ) {
    ...
    for ( var i = 0; i < inputs.length; i++ ) {
        ...
        var result = importsReplace( inputs[i], output );
...
var importsReplace = exports.importsReplace = function ( pathToFile, baseDir ) {
...
var importsSearch = exports.importsSearch = function ( data, dir ) {
    ...
    if ( importsList !== null ) {
        ...
        for ( var i = 0; i < importsList.length; i++ ) {
            ...
            if ( compiledImport instanceof Error ) {

                return new Error( importsList[i] );
...
var resolvePaths = exports.resolvePaths = function ( data, dir, base ) {
